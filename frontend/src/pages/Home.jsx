  ...
  return (
    <div style={{ position: 'relative', zIndex: 1 }}>
      ...
      <section style={{
        ...
        <div style={{ display: 'flex', gap: 72, marginTop: 100 }}>
          {[{ num: '280K+', label: 'Авторов' }, { num: '1.2M', label: 'Проектов' }, { num: '4.8B', label: 'Просмотров' }].map(s => (
            <div key={s.label} style={{ textAlign: 'center' }}>
              <div style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(32px, 4vw, 52px)', lineHeight: 1, letterSpacing: '-0.03em' }}>{s.num}</div>
      ...
      {/* CTA */}
      <section style={{ padding: '200px 48px', textAlign: 'center', position: 'relative', zIndex: 1 }}>
        ...
        <h2 style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(40px, 6vw, 88px)', lineHeight: 0.95, letterSpacing: '-0.045em' }}>
...
function Section({ label, title, icon, link, bg, children }) {
  return (
    <section style={{ padding: '140px 48px', position: 'relative', zIndex: 1, background: bg ? 'var(--surface)' : 'transparent' }}>
