          ...
          {registered ? (
            <>
              <div style={{ textAlign: 'center', padding: '20px 0' }}>
                ...
                <Dialog.Title style={{ fontFamily: 'var(--font-display)', fontSize: 24, marginBottom: 12 }}>
                  Проверьте почту
                </Dialog.Title>
                <Dialog.Description style={{ fontSize: 14, color: 'var(--text-2)', lineHeight: 1.7, marginBottom: 32 }}>
